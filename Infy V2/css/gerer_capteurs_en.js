...
for (var j=0;j<boutonsSupprimer.length;j++)
{
	boutonsSupprimer[j].onclick = function suppression() {
		...
		if (confirmSupprimer)
		{
			...
			{
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/supprimer_capteur.php",false);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send("ID="+IDelementsuppr);
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/affiche_capteur.php",true);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send('');
			}
			if (IDbouton[3] == 'T')
			{
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/supprimer_type_capteur.php",false);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send("ID="+IDelementsuppr);
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/affiche_type_capteur.php",true);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send('');
			}
			if (IDbouton[3] == 'B')
			{
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/supprimer_boitier.php",false);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send("ID="+IDelementsuppr);
				xmlhttp.open("POST",
					"../php_en/gerer_capteurs_AJAX/affiche_boitier.php",true);
				xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
				xmlhttp.send('');
			}
