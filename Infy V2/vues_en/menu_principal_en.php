...
<html>
    ...
    <body>
      ...
      <main>
          <div class="formule1">
              <h1>Psychotechnical Tests with Quick Reflex!</h1>
          </div>
          ...
          <article>
              ...
              <p>
                ...
                <ul>
                  <li> Yanouri Lina </li>
                  <li> Lacroix Marguerite</li>
                  <li> Desailly Jérémy </li>
                  <li> Herembert Malo </li>
                  <li> Tran Ba Tho Guillaume </li>
                  <li> Raboteau Thomas </li>
                </ul>
              </p>
          </article>
      </main>
