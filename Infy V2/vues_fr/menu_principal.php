...
<html>
    ...
    <body>
      ...
      <main>
          <div class="formule1">
              <h1>Testez-vous avec Quick Reflex !</h1>
          </div>
          ...
          <article>
              ...
              <p>
                  ...
                  <ul>
                      <li>Jérémy Desailly</li>
                      <li>Malo Herembert</li>
                      <li>Marguerite Lacroix</li>
                      <li>Thomas Raboteau</li>
                      <li>Guillaume Tran Ba Tho</li>
                      <li>Lina Yanouri</li>
                  </ul>
              </p>
          </article>
