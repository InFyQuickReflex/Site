...
<html>
    <head>
        ...
        <title id="titre">User menu</title>
    </head>
    ...
    <body>
        <header> 
            <p class="logo"> <img src="../img/infy2.png" alt="logo InFy" class="img_logo"> </br> by InFy Corporation </p>
                ...
                <nav>
                <ul id="langue">
                    <li><a href="../fr/menu_utilisateur_fr.php"><img src="../img/ic_fr.png" class="icone"></a></li>
        ...
        <div id="conteneur" class="conteneur">
            <div id="nouveautest" class="button">
                <a href="" ><p>Start a new test</p></a>
            </div>

            <div id="nouveautest" class="button">
                <a href="test_resume_en.php" ><p>Acces to my data</p></a>
            </div>

            <div id="nouveautest" class="button" >
                <a href="" ><p>Acces to the FAQ</p></a>
            </div>
        </div>

        <footer>
            <p class = "CGU"> Legal mentions:  </p>
            <nav>
                <ul id="footer">
